...
try {
  ...
  if($_SERVER['REQUEST_METHOD'] == "GET"){
    ...
    $queryCatalogo = query('SELECT cat_direccion_territorial_id, direccion_territorial FROM '.$GLOBALS["db_controlTrabajo"].'.cat_direccion_territorial cdt WHERE estatus = 1');
