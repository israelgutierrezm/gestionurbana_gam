...
$pdf->SetXY(70, 26);
$pdf->Cell(70, 10, utf8_decode('Lista de Evaluación'), 0, 1, 'C', 0);
...
$pdf->Cell(80, 15, utf8_decode('Nombre'), 1, 0, 'C', 0);
    $pdf->SetFont('Arial', '', 7);
    $pdf->MultiCell(15, 7.5, utf8_decode("Calificación EC"),1,'C');
    $pdf->SetXY(120,78);
    $pdf->MultiCell(15, 7.5, utf8_decode("Examen Final"),1,'C');
    $pdf->SetXY(135,78);
    $pdf->MultiCell(15, 7.5, utf8_decode("Calificación Definitiva"),1,'C');
    $pdf->SetXY(150,78);
    $pdf->MultiCell(15, 5, utf8_decode("Calificacion Definitiva en Letra"),1,'C');
    $pdf->SetXY(165,78);
    $pdf->Cell(30, 15, utf8_decode('Firma del Alumno'), 1,0, 'C', 0);

$pdf->SetXY(105,73);
$pdf->Cell(90, 5, utf8_decode('Evaluación Final'), 1,0, 'C', 0);
